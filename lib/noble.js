/**
 * @file noble.js bluetooth low energy device representation for node.js 
 ...
 * 
 * @param serviceUuids 		{?string[]}	an array of strings specifying service's UUID
 * @param allowDuplicates 	{?boolean}	true, allows duplicates false forbid them	
 * @param callback 			{?function}	function to call if errors	
 * 
 * @example
